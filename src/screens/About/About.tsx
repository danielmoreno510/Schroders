...
const About = () => (
  <ScrollView style={styles.container}>
    <Text style={styles.title}>Schroders</Text>
    ...
    <Text style={styles.text}>This project has a coverage of 76%</Text>
    <Image source={coverage} style={styles.image} />
    <Text style={styles.text}>
      In other projects I have implemented continuous integration processes with
      implementation within appcenter to download the ios and android builds
    </Text>
